 ...
 */
package org.eclipse.smarthome.binding.voismartswitch.test
 ...
 */
class VoismartSwitchOSGiTest extends OSGiTest {

	final ThingTypeUID BRIDGE_THING_TYPE_UID = new ThingTypeUID("voismartswitch", "bridge")
